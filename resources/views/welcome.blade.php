...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth">
    ...
    <body class="antialiased bg-gray-950 text-gray-100 font-sans selection:bg-yellow-500 selection:text-gray-900">
        ...
        <main class="relative bg-gray-900 overflow-hidden min-h-screen flex flex-col">
            ...
            <div class="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center flex-1 w-full">
                <div class="my-auto py-10 flex flex-col items-center w-full">
                    ...
                    <div class="mt-12 md:mt-20 grid grid-cols-3 gap-8 md:gap-16 border-t border-gray-800 pt-10 w-full">
                        <div>
