        ...
        <div class="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div class="w-full md:w-auto flex justify-center md:justify-end items-center gap-6 mt-4 md:mt-0">
                ...
                <div class="relative" x-data="{ openNotif: false }" @click.away="openNotif = false">
                    <button @click="openNotif = !openNotif; if(openNotif) { $wire.markNotificationsAsRead(); if('Notification' in window && Notification.permission === 'default') Notification.requestPermission(); }" class="flex items-center justify-center bg-gray-800/80 hover:bg-gray-700 p-3 rounded-2xl border border-gray-700 transition-all relative">
